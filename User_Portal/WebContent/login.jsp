    ...
    <h3 class="login_h3">Login Panel</h3>
       <div class="inner_box">
            <form action="login_form" method="post">
                ...
                <input class="form_data email-box" type="email" name="email" id="email" value="admin@localhost.local" required><br><br>
                <label class="form-login-label" for="pass">Password</label>
                <input class="form_data pass-box" type="password" name="pass" id="pass" required><br>
