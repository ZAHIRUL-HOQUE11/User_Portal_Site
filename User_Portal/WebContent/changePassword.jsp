<%@ page import="java.util.*, user.portal.*" %>
    ...
    <div class="right">
        ...
        <div class="main_pass">
            <form action="passChange" method="post">
                ...
                <input type="password" name="currentpass" id="pre" required><br><br>
                
                <label for="new">New Password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </label>
                <input type="password" name="newpass" id="new" required><br><br>
                
                <label for="confirm">Confirm Password &nbsp;&nbsp;&nbsp;:</label>
                <input type="password" name="conpass" id="confirm" required><br><br>
